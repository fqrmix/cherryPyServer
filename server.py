...
WEBHOOK_HOST = 'host'
WEBHOOK_PORT = 443  # 443, 80, 88 или 8443 sudo apt-get install openssl
...
if __name__ == '__main__':
    ...
    bot_1.set_webhook(url='https://122.122.122.122/CSR',
                    certificate=open(WEBHOOK_SSL_CERT, 'r'))    

    bot_2.remove_webhook()
    bot_2.set_webhook(url='https://122.122.122.122/MUSIC',
                    certificate=open(WEBHOOK_SSL_CERT, 'r'))
